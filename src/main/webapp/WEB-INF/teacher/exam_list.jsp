...
<body>
    ...
    <div class="modal_window teacher_clazz_window form-control" id="clazz-show">
        ...
        <div style="text-align: center;height: 100px;overflow-y: scroll;overflow-x: hidden;">
            <ul style="list-style: none;padding: 0px;margin: 0px;" id="clazz-list-container"></ul>
        </div>
        ...
        <div>
            年级:<select id="grade_select"></select>
            专业:<select id="major_select"><option>专业...</option></select>
