...
<body>
						...
						<tr>
							...
							<td>
								<button class="btn btn-default"
									onclick="toggleGradeEdit(true, this);">编辑</button>
	...
	<!--年级添加-->
	<div class="modal_window form-control" id="grade_add">
		<!--标题-->
	...
	<!--年级修改-->
	<div class="modal_window form-control" id="grade_edit">
		<!--标题-->
		<div class="modal_window_title">
			编辑年级: <img src="images/error.png" onclick="toggleGradeEdit(false);">
		</div>
		<form action="grade/edit" method="post" onsubmit="return editGrade(this);">
			<!--提交记录id-->
			<input type="hidden" name="id" id="grade_edit_id">
			<table>
				<tr>
					<td>年级名称:</td>
					<td><input type="text" name="grade" id="grade_edit_grade">
					</td>
				</tr>
				<tr style="text-align: center;">
					<td colspan="2"><span class="error" id="grade_edit_error">&nbsp;</span>
					</td>
				</tr>
				<tr style="text-align: center;">
					<td colspan="2"><input type="submit" value="提交"></td>
